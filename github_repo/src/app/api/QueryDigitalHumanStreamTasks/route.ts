...
/**
 * 查询所有运行中的数字人视频流任务
 * Action: QueryDigitalHumanStreamTasks
 * 无需业务参数
 */
export async function POST(req: NextRequest) {
  try {
    ...
    const queryString = generateQueryParamsString('QueryDigitalHumanStreamTasks', appId, serverSecret);
